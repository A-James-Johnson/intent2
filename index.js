...
async function connectToDb(){
    try{
        await mongoose.connect('mongodb+srv://James321485:James321485@cluster0.835jjax.mongodb.net/ExpenseTracker?retryWrites=true&w=majority&appName=Cluster0')
...
app.get('/get-expenses', async function(request, response) {
    try {
        ...
        response.status(201).json(expensesData)
    } catch(error) {
